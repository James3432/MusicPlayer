...
public class FeatureProcessor {
	...
	private jk509.player.AggregatorContainer aggregator;
	...
	public FeatureProcessor(int window_size, double window_overlap,
			...
			throws Exception {
		this.cancel = cancel;
		aggregator = new jk509.player.AggregatorContainer();
	 ...
	 */
	public List<double[]> extractFeatures(File recording_file, Updater updater)
			throws Exception {
