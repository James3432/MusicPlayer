...
public class GUIupdater implements Updater {
	 ...
	 * @param windowOverlap
	 *            Percent of the window that is duplicated between analysis windows
	 */
	/*
	 * public void setup(boolean perFile, boolean perWindow, String valuesSavePath, String definitionSavePath, int windowSize, double windowOverlap) { this.perFile = perFile; this.perWindow = perWindow; this.valuesSavePath = valuesSavePath; this.definitionSavePath = definitionSavePath; this.windowSize = windowSize; this.windowOverlap = windowOverlap; }
	 */
	 ...
	 */
	/*
	 * public void run() { try { SwingUtilities.invokeAndWait(suspendGUI); controller.dm_.validateFile(definitionSavePath,valuesSavePath); File feature_values_save_file = new File(valuesSavePath); File feature_definitions_save_file = new File(definitionSavePath);
	 * 
