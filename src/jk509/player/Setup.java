...
public class Setup extends JDialog {
	...
	public Setup() {
		...
		lblItLooksLike = new JLabel("It looks like this is the first time you've run Music Player.");
		...
		lblcusersjamesmusicplayer = new JTextField("\"C:\\Users\\James\\MusicPlayer\"");
		...
		lblFoundItunesLibrary = new JLabel("Found itunes library here / couldn't find itunes library.");
		...
		tblItunes.setModel(new DefaultTableModel(
			new Object[][] {
		...
		lblSelectOneOr = new JLabel("Select one or more songs and press delete to remove them");
		...
		lblLoadMoreItunes = new JLabel("Load more itunes stuff later using File -> Import from iTunes");
		...
		lblIfYouUse = new JLabel("If you use another media player such as \"Windows Media Player\", your music is probably stored in my music.");
		...
		lblLoadMoreMusic = new JLabel("Load more music later using File -> Import");
	...
	private class ThisWindowListener extends WindowAdapter {
		...
		public void windowClosing(WindowEvent arg0) {
			if(JOptionPane.showConfirmDialog(dialog, "The music player cannot be used until setup has completed.\nAre you sure you want to exit?","Warning",JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION)
				dispose();
		}
	}
	public void UpdateSidebar() {
		switch(stage){
			case 1: blt1.setEnabled(true);blt2.setEnabled(false);blt3.setEnabled(false);blt4.setEnabled(false);blt5.setEnabled(false);blt6.setEnabled(false);lblIntroduction.setEnabled(true);lblBasicSettings.setEnabled(false);lblImportFromItunes.setEnabled(false);lblImportFromMy.setEnabled(false);lblAnalyseAudio.setEnabled(false);lblFinished.setEnabled(false); break;
			case 2: blt1.setEnabled(false);blt2.setEnabled(true);blt3.setEnabled(false);blt4.setEnabled(false);blt5.setEnabled(false);blt6.setEnabled(false);lblIntroduction.setEnabled(false);lblBasicSettings.setEnabled(true);lblImportFromItunes.setEnabled(false);lblImportFromMy.setEnabled(false);lblAnalyseAudio.setEnabled(false);lblFinished.setEnabled(false); break;
			case 3: blt1.setEnabled(false);blt2.setEnabled(false);blt3.setEnabled(true);blt4.setEnabled(false);blt5.setEnabled(false);blt6.setEnabled(false);lblIntroduction.setEnabled(false);lblBasicSettings.setEnabled(false);lblImportFromItunes.setEnabled(true);lblImportFromMy.setEnabled(false);lblAnalyseAudio.setEnabled(false);lblFinished.setEnabled(false); break;
			case 4: blt1.setEnabled(false);blt2.setEnabled(false);blt3.setEnabled(false);blt4.setEnabled(true);blt5.setEnabled(false);blt6.setEnabled(false);lblIntroduction.setEnabled(false);lblBasicSettings.setEnabled(false);lblImportFromItunes.setEnabled(false);lblImportFromMy.setEnabled(true);lblAnalyseAudio.setEnabled(false);lblFinished.setEnabled(false); break;
			case 5: blt1.setEnabled(false);blt2.setEnabled(false);blt3.setEnabled(false);blt4.setEnabled(false);blt5.setEnabled(true);blt6.setEnabled(false);lblIntroduction.setEnabled(false);lblBasicSettings.setEnabled(false);lblImportFromItunes.setEnabled(false);lblImportFromMy.setEnabled(false);lblAnalyseAudio.setEnabled(true);lblFinished.setEnabled(false); break;
			case 6: blt1.setEnabled(false);blt2.setEnabled(false);blt3.setEnabled(false);blt4.setEnabled(false);blt5.setEnabled(false);blt6.setEnabled(true);lblIntroduction.setEnabled(false);lblBasicSettings.setEnabled(false);lblImportFromItunes.setEnabled(false);lblImportFromMy.setEnabled(false);lblAnalyseAudio.setEnabled(false);lblFinished.setEnabled(true); break;
		}
	}
